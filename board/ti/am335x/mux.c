...
static struct module_pin_mux mmc0_pin_mux[] = {
	{OFFSET(mii1_txclk), (MODE(3) | RXACTIVE | PULLUP_EN)},	/* MMC0_DAT7 */
	{OFFSET(mii1_rxclk), (MODE(3) | RXACTIVE | PULLUP_EN)},	/* MMC0_DAT6 */
	{OFFSET(mii1_rxd3), (MODE(3) | RXACTIVE | PULLUP_EN)},	/* MMC0_DAT5 */
	{OFFSET(mii1_rxd2), (MODE(3) | RXACTIVE | PULLUP_EN)},	/* MMC0_DAT4 */
...
static struct module_pin_mux rmii1_pin_mux_moxa[] = {
...
static struct module_pin_mux rmii2_pin_mux_moxa[] = {
...
static struct module_pin_mux mmc2_pin_mux[] = {
	...
	{OFFSET(gpmc_ad8), (MODE(3) | RXACTIVE | PULLUP_EN)},   /* MMC2_DAT4 */
	{OFFSET(gpmc_ad9), (MODE(3) | RXACTIVE | PULLUP_EN)},   /* MMC2_DAT5 */
	{OFFSET(gpmc_ad10), (MODE(3) | RXACTIVE | PULLUP_EN)},  /* MMC2_DAT6 */
	{OFFSET(gpmc_ad11), (MODE(3) | RXACTIVE | PULLUP_EN)},  /* MMC2_DAT7 */
...
#if 0
static struct module_pin_mux dcan_pin_mux_mxcore[] = {
	{OFFSET(uart0_ctsn), (MODE(2) )},  /* dcan1_tx */
	{OFFSET(uart0_rtsn), (MODE(2) | RXACTIVE )},  /* dcan1_rx */
	{-1},
};
#endif
...
static struct module_pin_mux spi1_pin_mux[] = {
	{OFFSET(ecap0_in_pwm0_out), (MODE(4) | RXACTIVE | PULLUDEN)},	/* SPI1 */
	{OFFSET(uart0_ctsn), (MODE(4) | RXACTIVE |
			PULLUDEN | PULLUP_EN)},  			/* SPI1_D0 */
	{OFFSET(uart0_rtsn), (MODE(4) | RXACTIVE | PULLUDEN)},  	/* SPI1_D1 */
	{OFFSET(uart1_ctsn), (MODE(4) | RXACTIVE |
...
static struct module_pin_mux gpio_pin_mux[] = {
	{OFFSET(gpmc_ad12), (MODE(7) | RXACTIVE | PULLUDDIS)},
	{OFFSET(gpmc_ad13), (MODE(7) | RXACTIVE | PULLUDDIS)},
	{OFFSET(gpmc_ad14), (MODE(7) | RXACTIVE | PULLUDDIS)},
	{OFFSET(gpmc_ad15), (MODE(7) | RXACTIVE | PULLUDDIS)},
	{-1},
};
...
//static struct module_pin_mux gpio_pin_mux_moxa_5100[] ={             
//	{OFFSET(lcd_vsync), (MODE(7) | RXACTIVE | PULLUDDIS)},       /* CPU_DI1 */
//	{OFFSET(lcd_hsync), (MODE(7) | RXACTIVE | PULLUDDIS)},       /* CPU_DI2 */
//	{OFFSET(lcd_pclk), (MODE(7) | RXACTIVE  | PULLUDDIS)},       /* CPU_DI3 */
//	{OFFSET(lcd_ac_bias_en), (MODE(7) | RXACTIVE  | PULLUDDIS)}, /* CPU_DI4 */
//	{OFFSET(gpmc_a6), MODE(7) | PULLUDDIS},                      /* CPU_DO1 */
//        {OFFSET(gpmc_a7), MODE(7) | PULLUDDIS},                      /* CPU_DO2 */
//	{OFFSET(gpmc_a8), MODE(7) | PULLUDDIS},                      /* CPU_DO3 */
//	{OFFSET(gpmc_a9), MODE(7) | PULLUDDIS},                      /* CPU_DO4 */
//	{-1},
//};

static struct module_pin_mux gpio_pin_mux_moxa[] ={
	{OFFSET(lcd_vsync), (MODE(7) | RXACTIVE | PULLUDDIS)},
	{OFFSET(lcd_hsync), (MODE(7) | RXACTIVE | PULLUDDIS)},
	{OFFSET(lcd_pclk), (MODE(7) | RXACTIVE  | PULLUP_EN)},
	{OFFSET(gpmc_ad4), (MODE(7) | RXACTIVE | PULLUDDIS)},
	{OFFSET(gpmc_ad5), (MODE(7) | RXACTIVE | PULLUDDIS)},
	{OFFSET(gpmc_ad6), (MODE(7) | RXACTIVE | PULLUDDIS)},
	{OFFSET(gpmc_ad12), (MODE(7) | RXACTIVE | PULLUDDIS)},
	{OFFSET(gpmc_ad13), (MODE(7) | RXACTIVE | PULLUDDIS)},
	{OFFSET(gpmc_ad14), (MODE(7) | RXACTIVE | PULLUDDIS)},
        {OFFSET(lcd_data0), (MODE(7) | RXACTIVE | PULLUDDIS)},                  /* DB_LED1/GPIO2_6 */
        {OFFSET(lcd_data1), (MODE(7) | RXACTIVE | PULLUDDIS)},                  /* DB_LED4/GPIO2_7 */
        {OFFSET(lcd_data2), (MODE(7) | RXACTIVE | PULLUDDIS)},                  /* DB_LED3/GPIO2_8 */
        {OFFSET(lcd_data3), (MODE(7) | RXACTIVE | PULLUDDIS)},                  /* DB_LED2/GPIO2_9 */
        {OFFSET(lcd_data4), (MODE(7) | RXACTIVE | PULLUDDIS)},                  /* DB_LED2/GPIO2_9 */
        {OFFSET(gpmc_be1n), (MODE(7) | RXACTIVE | PULLUP_EN)},                  /* BUZ_EN */
        {OFFSET(gpmc_clk), (MODE(7) | RXACTIVE | PULLUDEN | PULLUP_EN)},        /* SW_BTN */
	{-1},
};
...
static struct module_pin_mux mii1_pin_mux[] = {
	{OFFSET(mii1_col), MODE(0) | RXACTIVE},         /* MII1_RXERR */
	{OFFSET(mii1_crs), MODE(0) | RXACTIVE},         /* MII1_TXEN */
...
#endif
#if 0
static struct module_pin_mux led_pin_mux_moxa[] = {
	{OFFSET(gpmc_ad4), (MODE(7) | RXACTIVE | PULLUDEN)},    /* CEL1 */
	{OFFSET(gpmc_ad5), (MODE(7) | RXACTIVE | PULLUDEN)},    /* CEL2 */
	{OFFSET(gpmc_ad6), (MODE(7) | RXACTIVE | PULLUDEN)},    /* CEL3 */
	{OFFSET(gpmc_ad12), (MODE(7) | RXACTIVE | PULLUDEN)},   /* DIA1 */
	{OFFSET(gpmc_ad13), (MODE(7) | RXACTIVE | PULLUDEN)},   /* DIA2 */
	{OFFSET(gpmc_ad14), (MODE(7) | RXACTIVE | PULLUDEN)},   /* DIA3 */
	{OFFSET(gpmc_wen), (MODE(7) | RXACTIVE | PULLUDEN)},    /* USB */
	{OFFSET(gpmc_oen_ren), (MODE(7) | RXACTIVE | PULLUDEN)},        /* SD */
	{OFFSET(gpmc_advn_ale), (MODE(7) | RXACTIVE | PULLUDEN)},       /* Zig */
	{-1},
};
#endif
...
void enable_board_pin_mux(struct am335x_baseboard_id *header)
{
	...
	if (board_is_bone(header)) {
		...
		/*configure_module_pin_mux(mmc0_pin_mux_mxcore);
		configure_module_pin_mux(mmc1_pin_mux_mxcore);*/
		configure_module_pin_mux(spi1_pin_mux);
		configure_module_pin_mux(i2c2_pin_mux);
		configure_module_pin_mux(spi0_pin_mux);
		configure_module_pin_mux(rmii1_pin_mux_moxa);
		configure_module_pin_mux(rgmii2_pin_mux);
		configure_module_pin_mux(uart3_pin_mux);
		configure_module_pin_mux(gpio_pin_mux_moxa);
		...
		configure_module_pin_mux(i2c0_pin_mux);
		configure_module_pin_mux(rmii1_pin_mux_moxa);
		configure_module_pin_mux(rmii2_pin_mux_moxa);
		configure_module_pin_mux(gpio_pin_mux_moxa);
	} else {
