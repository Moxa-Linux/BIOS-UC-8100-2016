...
/* R00   05/16/2016   SHA   Setting for EEPROM ENV config */
...
#define CONFIG_SYS_MEMTEST_START        (PHYS_DRAM_1 + 0x4000000)
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"ethaddr=00:90:e8:00:00:41\0" \
	"eth1addr=00:90:e8:00:00:42\0" \
	"ipaddr=10.144.4.178\0" \
	"serverip=10.144.4.180\0" \
	"os_boot_priority=0\0" \
	"sd_protected=0\0" \
	"modelname=UC-8100\0" \
        "fastboot=0\0"\
        "realtime=0\0"\
	...
	"en_tpm2=1\0" \
        "robust=0\0"\
	"bootargs=mac=00:90:E8:40:4C:FD sd=1 ver=1 console=ttyO0,115200n8 root=/dev/mmcblk1p2 rootfstype=ext4 rootwait" 
#endif
...
#define CONFIG_SYS_I2C_PCA953X_WIDTH    { {0x21, 16} }
